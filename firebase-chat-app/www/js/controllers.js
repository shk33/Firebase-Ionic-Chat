...
.controller('MainCtrl', ['$scope', 'Loader', '$ionicPlatform',
  ...
  function($scope, Loader, $ionicPlatform, $cordovaOauth,
    FBFactory, GOOGLEKEY, GOOGLEAUTHSCOPE, UserFactory, currentAuth,
    $state) {
...
.controller('ChatsCtrl', ['$scope', '$rootScope', 'UserFactory',
  'Utils', '$ionicPlatform', '$state', function($scope, $rootScope,
    UserFactory, Utils, $ionicPlatform, $state) {
...
.controller('ChatDetailCtrl', ['$scope', 'Loader',
'$ionicPlatform', '$stateParams', 'UserFactory', 'FBFactory',
'$ionicScrollDelegate', '$cordovaImagePicker', 'Utils',
'$timeout', '$ionicActionSheet', '$cordovaCapture',
'$cordovaGeolocation', '$ionicModal',
  function($scope, Loader, $ionicPlatform, $stateParams,
  UserFactory, FBFactory, $ionicScrollDelegate, $cordovaImagePicker,
  Utils, $timeout, $ionicActionSheet, $cordovaCapture,
  $cordovaGeolocation, $ionicModal) {
    ...
    $ionicPlatform.ready(function() {
      ...
      $scope.sendMessage = function() {
        ...
        var msg = '<p>' + $scope.user.cachedUserProfile.name
                        + ' says : <br/>' + $scope.chatMsg + '</p>';
        var type = 'text';
